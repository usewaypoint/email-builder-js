    ...
    <div className="flex flex-col flex-1 min-w-0">
      ...
      <header className="flex h-14 items-center gap-2 border-b bg-background px-3 overflow-scroll">
              ...
              {headerTabs.map((tab, index) => {
                ...
                return (
                  <div
                    ...
                    className={`px-3 py-2 cursor-pointer transition-colors duration-300 h-[32px] flex items-center gap-2 ${index === activeIndex ? "text-foreground" : "text-muted-foreground"
                      }`}
        ...
        <div className="flex items-center gap-2">
          {/* Device Toggle Group */}
          <ToggleGroup type="single" value={deviceType} onValueChange={setDeviceType} className="border rounded-md gap-0 overflow-hidden">
